...
import { nodeHttpAdapter, nodeHttp2Adapter } from '../src/http-client/node-http-adapter.js';
...
runNodeTests('Node.js HTTP Adapters', () => {
  describe('nodeHttpAdapter', () => {
    ...
    it('should make a simple GET request', async () => {
      const response = await nodeHttpAdapter(`${baseUrl}/json`, { method: 'GET' });
    ...
    it('should handle HTTP errors', async () => {
      const response = await nodeHttpAdapter(`${baseUrl}/error`, { method: 'GET' });
